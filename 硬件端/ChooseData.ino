...
#define SSID           "ZY"                   // cannot be longer than 32 characters!
#define PASSWORD       "zouyan1999"
...
#define DEVICEID   "23077870"
#define PROJECTID "112710"
#define HOST_PORT   (80)
String apiKey="zrvXs0iXlBQ=wkZ8z8oZc1HwlFY=";
char buf[10];
...
{   
  ...
  if (irrecv.decode(&results)) {
    Serial.println(results.value, DEC);
        ...
        {
              case 33456255:Serial.print("1");
              num = 1;
              break;
              case 33439935:Serial.print("2");
              num = 2;
              break;
              case 33472575:Serial.print("3");
              num = 3;
              break;
              case 33431775:Serial.print("4");
              num = 4;
              break;
              case 33448095:Serial.print("5");
              num = 5;
              break;
              default:Serial.print("illegal input");
        } 
